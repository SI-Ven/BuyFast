...
import com.example.buyfast.modules.user.model.User; // Import User model
...
public class JwtService {
    ...
    public String generateToken(
        ...
        // --- NEW: Add token version to claims ---
