...
public class AuthController {
    ...
    // --- NEW ENDPOINT: Logout All ---
    @PostMapping("/logout-all")
    public ResponseEntity<ApiResponse<Object>> logoutAll(@AuthenticationPrincipal UserDetails userDetails) {
        authService.logoutAll(userDetails);
        return ResponseEntity.ok(ApiResponse.ok("Logged out from all devices successfully."));
    }
