...
public interface ProductVariantRepo {
    ...
    @Insert("INSERT INTO product_variant (variant_uuid, product_id, sku, price, stock_quantity, discount_percentage, is_active, created_at) " +
            "VALUES (#{variantUuid}, #{productId}, #{sku}, #{price}, #{stockQuantity}, #{discountPercentage}, #{isActive}, CURRENT_TIMESTAMP)")
